...
?>
<?php get_header(); ?>
<section class="hero hero__header--cover bottom" style="background-image: url(<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Без\ имени-1\ 2.png);">
<div class="container">
                    ...
                    <div class="col-md-6 about__card__itemWrapper">
                        ...
                        <div class="about__card__item">
                            <div class="about__card__itemContent">
                                ...
                                <p>
                                    Currently, the UK has a unified deposit and deposit insurance system for both
                                    ...
                                    of converting to the currency in which you have deposit).
