...
<section class="text-block">
    ...
    2. Commission is taken only when opening a position, when doubling the levels listed in the table above (accounting for both opening and closing a position). Since the clients total trading volume is calculated monthly, commissions will be charged at the highest level at the beginning of each month, and if trading volumes increase during the month, it will automatically decrease to reflect the trading volumes.<br>
